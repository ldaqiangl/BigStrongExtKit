...
+ (MB_INSTANCETYPE)showHUDAddToView:(UIView *)view labelText:(NSString *)labelText detailsLabelText:(NSString *)detailsLabelText mode:(MBProgressHUDMode)mode animationType:(MBProgressHUDAnimation)animationType isShowCancelButton:(BOOL)isShow cancelBlock:(MBProgressHUDCancelBlock)cancelBlock completionBlock:(MBProgressHUDCompletionBlock)completion afterDelay:(NSTimeInterval)delay animated:(BOOL)animated
{
    __autoreleasing MBProgressHUD * hud=[[MBProgressHUD alloc] initWithView:view];
...
+ (MB_INSTANCETYPE)showHUDonWindowWithLabelText:(NSString *)labelText detailsLabelText:(NSString *)detailsLabelText mode:(MBProgressHUDMode)mode animationType:(MBProgressHUDAnimation)animationType isShowCancelButton:(BOOL)isShow cancelBlock:(MBProgressHUDCancelBlock)cancelBlock completionBlock:(MBProgressHUDCompletionBlock)completion afterDelay:(NSTimeInterval)delay animated:(BOOL)animated
{
    UIWindow *kWindow=[[[UIApplication sharedApplication] delegate] window];
...
+ (MB_INSTANCETYPE)showHUDAddToView:(UIView *)view labelText:(NSString *)labelText detailsLabelText:(NSString *)detailsLabelText mode:(MBProgressHUDMode)mode animationType:(MBProgressHUDAnimation)animationType isShowCancelButton:(BOOL)isShow cancelBlock:(MBProgressHUDCancelBlock)cancelBlock completionBlock:(MBProgressHUDCompletionBlock)completion animated:(BOOL)animated
{
    __autoreleasing MBProgressHUD * hud=[[MBProgressHUD alloc] initWithView:view];
    hud.isShowCancelButton=isShow;
    hud.cancelBlock=cancelBlock;
...
+ (MB_INSTANCETYPE)showHUDonWindowWithLabelText:(NSString *)labelText detailsLabelText:(NSString *)detailsLabelText mode:(MBProgressHUDMode)mode animationType:(MBProgressHUDAnimation)animationType isShowCancelButton:(BOOL)isShow cancelBlock:(MBProgressHUDCancelBlock)cancelBlock completionBlock:(MBProgressHUDCompletionBlock)completion animated:(BOOL)animated
{
    UIWindow *kWindow=[[[UIApplication sharedApplication] delegate] window];
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.isShowCancelButton)
    {
        ...
        self.cancelButton.frame=CGRectMake(boxRect.origin.x+5, boxRect.origin.y+boxRect.size.height-40, boxRect.size.width-10, 35);
    }
    else{
        if (self.isShowCancelButton)
        {
